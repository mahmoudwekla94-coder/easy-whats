...
module.exports = async function webhook(req, res) {
  ...
  try {
    ...
    console.log("PHONE RAW:", customerPhone);
    console.log("PHONE E164:", e164Phone);
    console.log("PHONE DIGITS:", digitsPhone);

    if (!digitsPhone || digitsPhone.length < 9) {
      console.log("ERROR: invalid phone", customerPhone);
    ...
    if (!API_BASE_URL || !VENDOR_UID || !API_TOKEN) {
      console.log("ERROR: missing env vars", { API_BASE_URL: !!API_BASE_URL, VENDOR_UID: !!VENDOR_UID, API_TOKEN: !!API_TOKEN });
    ...
    console.log("SAAS RESPONSE:", JSON.stringify(responseData));
    ...
    console.error("INTERNAL ERROR:", err?.message, String(err));
